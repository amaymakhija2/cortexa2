        ...
        >
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.99 }}
              className="font-body w-full py-5 px-8 bg-white text-stone-900 text-lg font-semibold rounded-2xl transition-all duration-300 hover:shadow-lg hover:shadow-white/10 flex items-center justify-center gap-3"
            >
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="font-body text-stone-500 text-sm">or sign in with email</span>
              <div className="flex-1 h-px bg-stone-700/50" />
            </div>
          </motion.div>
