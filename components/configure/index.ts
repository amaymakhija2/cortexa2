// Barrel exports for configure tab components
export * from './shared';
...
export { GoalHistoryModal } from './GoalHistory';
export { PracticeGoalsTab } from './PracticeGoalsTab';
export { ThresholdsTab } from './ThresholdsTab';
export { ConsultationFlowTab } from './ConsultationFlowTab';
export { EHRConnectionTab } from './EHRConnectionTab';
